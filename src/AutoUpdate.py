...
from ParsingUtility import get_bulletin_image_path
from ParsingUtility import process_image
from ParsingUtility import decode_image
from ParsingUtility import get_top_level_directory_path
from ParsingUtility import check_date
from ParsingUtility import get_bulletin_dimensions
from ParsingUtility import clean_dir
from ParsingUtility import compute_new_cases
from ParsingUtility import compute_cases_growth_factor
from ParsingUtility import compute_active_cases
from ParsingUtility import compute_new_active_cases
from ParsingUtility import compute_new_deaths
from ParsingUtility import compute_deaths_growth_factor
from ParsingUtility import compute_case_fatality_rate
from ParsingUtility import compute_new_tests
from ParsingUtility import compute_tests_growth_factor
from ParsingUtility import compute_daily_positivity_rate
from ParsingUtility import compute_new_recovered
from ParsingUtility import compute_recovered_growth_factor
...
def run(opt_date=datetime.date.today().strftime('%Y-%m-%d')):
    ...
    main_config = cu.Config(top_level_directory + '/src/TwitterUpdateConfig.dat')
    auth_config = cu.Config(top_level_directory + '/src/auth.dat')
