...
class ScatterPlot:
    ...
    # digit_font -> string
    # filename -> string
    def __init__(self, x_dataset, y_dataset, linestyle, marker, color, legend, label, linewidth, rolling_avg, n_rolling_avg,
...
class BarPlot:
    ...
    # digit_font -> string
    # filename -> string
    def __init__(self, x_dataset, y_dataset, color, label, legend, rolling_avg, n_rolling_avg, rolling_avg_label, 
                 x_axis_label, x_axis_labelsize, x_axis_orientation, x_ticks_size, y_axis_label, y_axis_labelsize,
                 title, title_size, super_title, super_title_size, text_font, digit_font,  filename):
            self.x_dataset = x_dataset
            self.y_dataset = y_dataset
            self.color = color
            self.label = label
