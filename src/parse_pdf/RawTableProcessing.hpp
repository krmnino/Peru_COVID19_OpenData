...
int process_ma_distr(tl::Table*&, tl::Table*&, cl::Config*, cl::Config*);
...
int append_begin_ca_distr_21(tl::Table*&, cl::Config*, std::string, cl::Config*);
...
int append_end_ma_distr(tl::Table*&, cl::Config*, std::string, cl::Config*);
