...
int main() {
	...
	// Process MuertesAcumulaDistritoP2.csv
	{
		tl::Table* input_raw_table_p1;
		tl::Table* input_raw_table_p2;
		process_ma_distr(input_raw_table_p1, input_raw_table_p2, main_config, distr_index);
		append_end_ma_distr(input_raw_table_p1, main_config, report_date, distr_index);
