...
int append_end_ca_distr_20(tl::Table*& input_raw_table, cl::Config* main_config, cl::Config* areas_config, cl::Config* distr_index) {
...
int append_end_ca_distr_21(tl::Table*& input_raw_table, cl::Config* main_config, cl::Config* areas_config, cl::Config* distr_index) {
	if (input_raw_table->get_rows() != distr_index->get_n_entries()) {
		return -1;
	}
