...
int append_begin_pa_depto(Table*& input_raw_table, Config* main_config, Config* areas_config, Config* dept_index) {
...
int append_begin_ca_depto(Table*& input_raw_table, Config* main_config, Config* areas_config, Config* dept_index) {
	if (input_raw_table->get_rows() != dept_index->get_n_pairs()) {
		return -1;
	}
...
int append_begin_ma_depto(Table*& input_raw_table, Config* main_config, Config* areas_config, Config* dept_index) {
	if (input_raw_table->get_rows() != dept_index->get_n_pairs()) {
		return -1;
	}
...
int append_begin_ma_deptosm(Table*& input_raw_table, Config* main_config, Config* areas_config, Config* dept_index) {
	if (input_raw_table->get_rows() != dept_index->get_n_pairs()) {
		return -1;
	}
...
int append_begin_ca_distr_20(Table*& input_raw_table, Config* main_config, Config* areas_config, Config* distr_index) {
...
int append_begin_ca_distr_21(Table*& input_raw_table, Config* main_config, Config* areas_config, Config* distr_index) {
	if (input_raw_table->get_rows() != distr_index->get_n_pairs()) {
		return -1;
	}
...
int append_begin_ma_distr(Table*& input_raw_table, Config* main_config, Config* areas_config, Config* distr_index) {
	if (input_raw_table->get_rows() != distr_index->get_n_pairs()) {
		return -1;
	}
