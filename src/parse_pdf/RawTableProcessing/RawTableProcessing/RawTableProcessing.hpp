...
int process_ma_deptosm(Table*&, Config*, Config*, Config*);
...
int append_begin_ma_deptosm(Table*&, Config*, Config*, Config*);
...
int append_end_ma_depto(Table*&, Config*, Config*, Config*);
int append_end_ma_deptosm(Table*&, Config*, Config*, Config*);
int append_end_ca_distr_20(Table*&, Config*, Config*, Config*);
