...
int append_begin_pa_depto(tl::Table*& input_raw_table, cl::Config* main_config, std::string date, cl::Config* dept_index) {
...
int append_begin_ca_depto(tl::Table*& input_raw_table, cl::Config* main_config, std::string date, cl::Config* dept_index) {
	// Extract top level directory path
	#ifdef LINUX
	std::string top_level_path = main_config->get_value("LinuxTopLevel")->get_data<std::string>();
	#else
...
int append_begin_cp_edades(tl::Table*& input_raw_table, cl::Config* main_config, std::string date, cl::Config* age_index) {
	// Extract top level directory path
	#ifdef LINUX
	std::string top_level_path = main_config->get_value("LinuxTopLevel")->get_data<std::string>();
	#else
...
int append_begin_ma_deptosm(tl::Table*& input_raw_table, cl::Config* main_config, std::string date, cl::Config* dept_index) {
	// Extract top level directory path
	#ifdef LINUX
	std::string top_level_path = main_config->get_value("LinuxTopLevel")->get_data<std::string>();
	#else
...
int append_begin_ca_distr_21(tl::Table*& input_raw_table, cl::Config* main_config, std::string date, cl::Config * distr_index) {
	// Extract top level directory path
	#ifdef LINUX
	std::string top_level_path = main_config->get_value("LinuxTopLevel")->get_data<std::string>();
	#else
